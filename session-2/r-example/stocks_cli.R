...
if (length(args) != 3) {
  stop("Please provide three command line arguments: ticker, start date, and end date.")
}
...
save_plot_as_pdf(ticker, start_date, end_date)

# on command line run this: 
# Rscript stocks_cli.R AMZN 2013-01-01 2017-06-01
